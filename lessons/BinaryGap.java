...
public class BinaryGap {
	...
	public static void main(String[] args) {
		...
		Map<Integer, Integer> testCases = Map.of(15, 0, 20, 1, 32, 0, 529, 4);

		String messageTemplate = "BinaryGap of %3d [%10s] (expected: %d) -> Actual: %d";
		testCases.entrySet().forEach(entry -> System.out.println(String.format(messageTemplate,
				entry.getKey(), Integer.toBinaryString(entry.getKey()), entry.getValue(), s.solution(entry.getKey()))));
	}
